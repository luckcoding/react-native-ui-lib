...
class Button extends PureComponent {
    ...
    renderLabel() {
        ...
        if (label) {
            return (<Text style={[this.styles.text, !!color && { color }, labelSizeStyle, { ...typography }, labelStyle]} numberOfLines={1} {...labelProps}>
          {label}
        </Text>);
        }
        return null;
    ...
    render() {
        ...
        return (<TouchableOpacity row centerV style={[
